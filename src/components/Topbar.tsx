                ...
                <div className='flex w-[80%] items-center justify-between text-green-blue'>
                    ...
                    {active == 'house' ? (
                        <Link href='/' className='hidden lg:flex items-center group'>
                            <House className='text-4xl transform lg:translate-x-2 lg:group-hover:translate-x-0 transition-transform' weight='fill' />
                    ...
                    {active == 'habits' ? (
                        <Link href='/habits' className='hidden lg:flex items-center group'>
                            <ArrowsClockwise className='text-4xl transform lg:translate-x-2 lg:group-hover:translate-x-0 transition-transform' weight='fill' />
                    ...
                    {active == 'diary' ? (
                        <Link href='/diary' className='hidden lg:flex items-center group'>
                            <BookBookmark className='text-4xl transform lg:translate-x-2 lg:group-hover:translate-x-0 transition-transform' weight='fill' />
                    ...
                    {active == 'contacts' ? (
                        <Link href='/contacts' className='hidden lg:flex items-center group'>
                            <Phone className='text-4xl transform lg:translate-x-2 lg:group-hover:translate-x-0 transition-transform' weight='fill' />
